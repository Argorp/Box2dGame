...
public class HorizontalTrashGoingRightObject extends GameObject{

    public int hp;

    public HorizontalTrashGoingRightObject(int width, int height, String texturePath, World world) {
        super(
                texturePath,
                0,
    ...
    public boolean isInFrame() {
        return getX() + width / 2 < GameSettings.SCREEN_WIDTH;
    }
}
